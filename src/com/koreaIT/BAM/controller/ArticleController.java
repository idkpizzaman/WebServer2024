...
public class ArticleController extends Controller {
	...
	private void doWrite() {
		...
		Article article = new Article(number, Util.getDateStr(), loginedMember.getId(), title, content, 0);
	...
	private String getLoginIdByMemberId(int memebrId) {
		for (Member member : members) {
			if (memebrId == member.getId()) {
	...
	public void makeTestData() {
		...
		for (int i = 1; i <= 5; i++) {
			articles.add(new Article(number++, Util.getDateStr(), i, "제목" + i, "내용" + i, i * 10));
		}
	}
